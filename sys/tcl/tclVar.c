				 ...
				 * TCL_LEAVE_ERR_MSG . */
{
	...
	my_strcpy(newVarPtr->value.string, varPtr->value.string);
	...
	my_strcpy(varPtr->value.string + varPtr->valueLength, newValue);
    ...
    char **argv;			/* Argument strings. */
{
    ...
    if ((c == 'a') && (my_strncmp(argv[1], "anymore", length) == 0)) {
	...
	interp->result = "1";
	return TCL_OK;
    } else if ((c == 'd') && (my_strncmp(argv[1], "donesearch", length) == 0)) {
    ...
    } else if ((c == 'n') && (my_strncmp(argv[1], "names", length) == 0)
	    && (length >= 2)) {
    ...
    } else if ((c == 'n') && (my_strncmp(argv[1], "nextelement", length) == 0)
	    && (length >= 2)) {
	ArraySearch *searchPtr;
	Tcl_HashEntry *hPtr;
    ...
    } else if ((c == 's') && (my_strncmp(argv[1], "startsearch", length) == 0)
	    && (length >= 2)) {
	ArraySearch *searchPtr;
